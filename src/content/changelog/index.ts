...
export const RELEASES: readonly ReleaseDef[] = [
  release('0.13.1', '2026-09-26', [
    { kind: 'changed', slug: 'title_screen', lead: true },
    { kind: 'changed', slug: 'patch_notes', lead: true },
    { kind: 'fixed', slug: 'notes_loading' },
    { kind: 'fixed', slug: 'logo_shine' },
    { kind: 'fixed', slug: 'notes_facts' },
  ]),
  release('0.13.0', '2026-09-26', [
    { kind: 'added', slug: 'unwritten', lead: true },
    { kind: 'added', slug: 'company', lead: true },
    { kind: 'added', slug: 'inscriptions' },
    { kind: 'added', slug: 'events' },
    { kind: 'added', slug: 'relics' },
    { kind: 'added', slug: 'omens' },
    { kind: 'added', slug: 'scriptorium' },
    { kind: 'added', slug: 'tithe' },
    { kind: 'added', slug: 'records' },
    { kind: 'added', slug: 'deeds' },
    { kind: 'changed', slug: 'modes' },
    { kind: 'changed', slug: 'wallet' },
    { kind: 'balance', slug: 'ranks' },
  ]),
  release('0.12.0', '2026-09-26', [
    { kind: 'added', slug: 'hall', lead: true },
    { kind: 'added', slug: 'challenges', lead: true },
    { kind: 'added', slug: 'renown' },
    { kind: 'added', slug: 'frames' },
    { kind: 'added', slug: 'titles' },
    { kind: 'added', slug: 'retroactive' },
    { kind: 'changed', slug: 'profile' },
    { kind: 'fixed', slug: 'gear' },
    { kind: 'fixed', slug: 'bulwark' },
  ]),
  release('0.11.0', '2026-09-26', [
    { kind: 'added', slug: 'instant', lead: true },
    { kind: 'added', slug: 'count' },
    { kind: 'added', slug: 'team' },
    { kind: 'added', slug: 'marks' },
    { kind: 'changed', slug: 'launch' },
    { kind: 'changed', slug: 'quests' },
  ]),
  release('0.10.0', '2026-09-26', [
    { kind: 'added', slug: 'mine', lead: true },
    { kind: 'added', slug: 'levels' },
    { kind: 'added', slug: 'sigils' },
    { kind: 'changed', slug: 'store' },
    { kind: 'changed', slug: 'fountain' },
    { kind: 'balance', slug: 'first_store' },
  ]),
  release('0.9.10', '2026-09-26', [
    { kind: 'added', slug: 'titan_easy', lead: true },
    { kind: 'added', slug: 'eternal_keys', lead: true },
    { kind: 'changed', slug: 'boss_gate' },
    { kind: 'fixed', slug: 'pale_herald' },
    { kind: 'fixed', slug: 'wallet_sources' },
    { kind: 'fixed', slug: 'varkos' },
    { kind: 'fixed', slug: 'obtain' },
  ]),
  release('0.9.9', '2026-09-25', [
    { kind: 'changed', slug: 'path', lead: true },
    { kind: 'added', slug: 'go', lead: true },
    { kind: 'changed', slug: 'ledger' },
    { kind: 'changed', slug: 'daily_rewards' },
    { kind: 'changed', slug: 'wallet' },
    { kind: 'added', slug: 'energy_refill' },
    { kind: 'changed', slug: 'bag' },
    { kind: 'fixed', slug: 'wallet_zero' },
    { kind: 'fixed', slug: 'stage_numbers' },
  ]),
  release('0.9.8', '2026-09-23', [
    { kind: 'changed', slug: 'summoning', lead: true },
    { kind: 'changed', slug: 'brewery', lead: true },
    { kind: 'changed', slug: 'portal' },
    { kind: 'changed', slug: 'cards' },
    { kind: 'added', slug: 'sounds' },
    { kind: 'added', slug: 'brewery_week' },
    { kind: 'changed', slug: 'tutorial_strip' },
    { kind: 'changed', slug: 'owed' },
  ]),
  release('0.9.7', '2026-09-23', [
    { kind: 'changed', slug: 'results', lead: true },
    { kind: 'changed', slug: 'tower', lead: true },
    { kind: 'added', slug: 'defeat' },
  ...
  release('0.4.0', '2026-09-20', [
    { kind: 'changed', slug: 'target_then_ability', lead: true },
    { kind: 'changed', slug: 'one_word_names' },
    { kind: 'changed', slug: 'index_sorted' },
    { kind: 'changed', slug: 'gear_rack' },
    { kind: 'changed', slug: 'cooldown_on_icon' },
  ...
  release('0.1.0', '2026-09-16', [
    ...
    { kind: 'changed', slug: 'screen_errors' },
  ]),
  ...
  release('0.0.9.1', '2026-09-15', [
    ...
    { kind: 'balance', slug: 'chest_materials' },
  ]),
  ...
  release('0.0.7', '2026-09-14', [{ kind: 'added', slug: 'forge', lead: true }]),
  release('0.0.6', '2026-09-14', [
    { kind: 'added', slug: 'gear', lead: true },
    { kind: 'added', slug: 'gear_sets' },
  ]),
