...
export const GEAR_SETS: readonly GearSetDef[] = [
  ...
  set({
    ...
    effects: [{ kind: 'stat_mod', stat: 'atk', percent: 15 }],
    homes: [1, 7],
  }),
  set({
    slug: 'swiftfoot',
    ...
    effects: [{ kind: 'stat_mod', stat: 'spd', percent: 12 }],
    homes: [2, 8],
  }),
  set({
    slug: 'keen_eye',
    ...
    effects: [{ kind: 'stat_mod', stat: 'critRate', flat: 12 }],
    homes: [3, 10],
  }),
  set({
    slug: 'executioner',
    ...
    effects: [{ kind: 'stat_mod', stat: 'critDmg', flat: 20 }],
    homes: [4, 9],
  }),
  set({
    slug: 'warding',
    ...
    effects: [{ kind: 'stat_mod', stat: 'res', flat: 30 }],
    homes: [3, 11],
  }),
  set({
    slug: 'truesight',
    ...
    effects: [{ kind: 'stat_mod', stat: 'acc', flat: 40 }],
    homes: [4],
  }),
  set({
    slug: 'lifedrinker',
  ...
  set({
    ...
    effects: [{ kind: 'counterattack', chance: 30 }],
    homes: [6, 11],
  }),
  set({
    slug: 'relentless',
    ...
    effects: [{ kind: 'extra_turn_chance', chance: 18 }],
    homes: [7, 12],
  }),
  set({
    slug: 'immortal',
    ...
    effects: [
      ...
      { kind: 'heal', target: 'self', mult: 0.03, stat: 'CASTER_MAX_HP' },
    ],
    homes: [8],
  }),
  set({
  ...
  set({
    ...
    trigger: 'onWaveStart',
    effects: [{ kind: 'apply_status', target: 'self', status: 'shield', value: 0.2, turns: 3, chance: 100 }],
    homes: [10],
  }),
];
