...
export const market = {
  ...
  'market.subtitle': 'One stall changes hands every hour. The other never changes at all.',
  ...
  'market.toBag': 'It is in your Bag.',
  'market.empty': 'The stall is bare this hour.',
