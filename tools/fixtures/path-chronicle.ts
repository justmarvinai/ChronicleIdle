...
const COUNTERS: Readonly<Record<string, number>> = {
  ...
  'idle.hours': 300,
  'boss.fights': 78,
  'boss.fights.boss.gravemaw': 62,
  'boss.fights.boss.gravemaw.easy': 22,
  'boss.fights.boss.gravemaw.normal': 28,
  'boss.fights.boss.gravemaw.hard': 12,
  'boss.fights.boss.nyxara': 16,
  'boss.fights.boss.nyxara.normal': 16,
