...
| Generated sounds (in-house) | `tools/audio/recipes.ts` → `public/assets/generated/audio/generated/` | 22 files | OGG Vorbis, mono-summed to stereo, loudness reported in the manifest | UI ticks, rewards, stingers, ambience drone, and the seven summon-ritual sounds (`sfx.summon.*`); rendered by `pnpm assets:build`, cached on the recipe sources |
...
| Summon ritual: `sfx.summon.charge`, `crack`, `reveal_{common,rare,epic,legendary,mythic}` | generated (`tools/audio/recipes.ts`), one reveal per tier |
